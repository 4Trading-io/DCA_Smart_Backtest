...
MESSAGES = {
    'en': {
        'welcome_intro': 
            "👋 *Hello!* Welcome to the **Crypto & Gold DCA Back Test Bot**. We're here to help you make smart, data-driven investment decisions.\n\n"
    ...
    'fa': {
        'welcome_intro': 
            "👋 *سلام!* به **ربات بکنست سرمایه‌گذاری کریپتو و طلا** خوش آمدید. ما به شما کمک می‌کنیم که تصمیماتی هوشمندانه و مبتنی بر داده‌ها در سرمایه‌گذاری بگیرید.\n\n"
            ...
            "🌐 *آماده‌ای؟* بیایید زبان موردنظر خود را انتخاب کنید.\n **لطفا تمامی اعداد را به انگلیسی وارد کنید!**",
        ...
        'ask_total_investment': "🔹 *بودجه کل سرمایه‌گذاری* خود را به دلار وارد کنید (مثلاً `10000` ):",
        ...
        'ask_monthly_limit': "🔹 *حداکثر سرمایه‌گذاری ماهانه* را وارد کنید (مثلاً `1000` ):",
        'ask_weekly_limit': "🔹 *حداکثر سرمایه‌گذاری هفتگی* را وارد کنید (مثلاً `250` ):",
        'ask_min_invest': "🔹 *حداقل سرمایه‌گذاری در هر خرید* را وارد کنید (مثلاً `50` ):",
        'ask_max_invest': "🔹 *حداکثر سرمایه‌گذاری در هر خرید* را وارد کنید (مثلاً `250` ):",
